...
#include <WS2tcpip.h>
#include "Function.h"
// POP3Server.cpp : Ýòîò ôàéë ñîäåðæèò ôóíêöèþ "main". Çäåñü íà÷èíàåòñÿ è çàêàí÷èâàåòñÿ âûïîëíåíèå ïðîãðàììû.
		...
		while (strcmp(command, "QUIT")) {
			...
			while (strcmp(command, "QUIT") && (access == 1)) {
				...
				if (!strcmp(command, "RETR"))
				{
					...
					for (int p = 0; list[p] != 0; p++)
						h++;
					if (k < h) {//Специально допущена ошибка, должен отправлять +OK
